package net.bastian1110.prospero.entity.animations;
    ...
    public static final AnimationDefinition FIONO_IDLE = AnimationDefinition.Builder.withLength(0.75f).looping()
            ...
            .addAnimation("head",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            new Keyframe(0f, KeyframeAnimations.posVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR))).build();
    public static final AnimationDefinition FIONO_WALK = AnimationDefinition.Builder.withLength(0.5416766f).looping()
